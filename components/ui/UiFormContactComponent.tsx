...
export const UiFormContactComponent: FC = () => {
  ...
  return (
    <section className='w-full flex flex-row justify-center items-center'>
      <div className='w-full xl:w-[90%] 2xl:w-[85%] 3xl:w-[70%] flex flex-col lg:flex-row relative'>
        <ToastContainer />
        ...
        {!loading && (
          <form
            ...
            onSubmit={onSubmit}
          >
            <div className='w-full sm:w-[60%] flex flex-col gap-4 py-5 xl:py-10 2xl:py-32'>
