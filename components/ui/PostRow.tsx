...
export function PostRow({ date, category, minutesLabel, title, href }: Props) {
  return (
    <Link
      href={href}
      className="grid grid-cols-[90px_minmax(0,1fr)_28px] sm:grid-cols-[150px_90px_minmax(0,1fr)_28px] items-center gap-5 py-[18px] px-2 border-t border-[var(--dc-border)] cursor-pointer hover:bg-[var(--dc-surface)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e8e6dd]"
    >
