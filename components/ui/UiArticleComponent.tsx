...
export const UiArticleComponent: FC<IUiArticleComponentProps> = ({
  ...
  return (
    <article
      className={`w-full h-80 ${bgButton} rounded-md px-2 flex flex-col shadow-md hover:transform hover:ease-in-out hover:duration-500 transform ease-in-out duration-500 hover:scale-105`}
      key={project.id}
    >
